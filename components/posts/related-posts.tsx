...
export const RelatedPosts = ({ data }) => {
  return (
    <>
      {data.map((postData) => {
        ...
        return (
          <div className="px-4 w-full md:w-1/3 pb-8">
            <Link
              ...
              passHref
            >
              <a key={post.id} className="group block mb-8 last:mb-0  h-full">
                {/* POst image */}
                {!post?._values.heroImg ? (
                  <div className="relative pb-[70%] overflow-hidden bg-gold-gradient1/10"></div>
