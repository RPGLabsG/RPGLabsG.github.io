---
title: Gran Saga Unlimited | Primer
...
This article is written based on my personal research on the project, and over 60 hours of gameplay in the latest playtest.  I was one of only 812 players, out of 8,000 who reached level 30 over the course of this playtest, alongside 10 other gamers from The Kingdom.  I ran through most of the available content (multiple times) and even got to experience the end-game raid that only a select few managed to qualify for.

This was *by far* one of the most polished titles I’ve ever experienced during all my time in Web3 gaming, and I will be telling you all about the gameplay, my opinions, and what we can expect from it in the future, including news about the next chance to play, and how to get ready for it.
...
This is a title The Kingdom will definitely be revisiting. We want to provide more information once it’s available and are genuinely just excited to play again.
