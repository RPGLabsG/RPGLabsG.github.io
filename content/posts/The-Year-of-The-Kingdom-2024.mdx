...
![](https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/GCjGkNxXcAAC3mw.jpg)
...
* First Priorities:
  ...
  * Take a detailed look at the mint, rarity drop chances, and silver production rates to ensure the economy is healthy and balanced as intended, followed by any balancing actions that need to take place and a full report on the collection for the community.
...
* Website: [https://the-kingdom.world/](https://the-kingdom.world/) 
* Whitepaper: [https://rpglabs.gitbook.io/thekingdomseconomy/document-introduction/what-is-the-kingdom](https://rpglabs.gitbook.io/thekingdomseconomy/document-introduction/what-is-the-kingdom) 

![](<https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/Artboard 1Tweet 7.jpg>)
