...
* **Company Structure, Legal Team & ESOP: **We built a legal department to help set up an ESOP framework for our team. It was a tiny team that helped make last year possible. We believe having a shared company-wide goal is incredibly important and is the foundation of our company.  In our company, from top to bottom, everyone is working toward the same objectives and same ambitions. Too often companies silo equity at the top. We want our team to think and act like co-owners, and now they can. When we had the initial funding to make an ESOP happen, we took the opportunity, knowing it would result in a better execution of our ambitions as every team member is working toward the same objective. Being bootstrapped by our founder has enabled us to have a clean cap table, so making team members co-owners is straightforward and leaves us a war chest to build on the amazing talent we have already acquired. 
