...
There is nothing out there like The Kingdom. With our unique approach to the genre focuses on maximum accessibility and a novel living world that we’ve been building for two years, we are not just participating in this serendipitous boom, but leading the charge.

![](https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/ephyr_sketches_2.jpg)
...
* Legal Team & ESOP: We built a legal department to help set up an ESOP framework for our team. It was a tiny team that helped make last year possible. We believe having a shared goal that everyone is working together toward is important both in gaming and business. So, when we had the initial funding to make an ESOP happen, we took the opportunity, knowing it would result in a better company and thus a better end product for the community. In short, being bootstrapped by our founder has enabled us to have a clean cap table, so making team members co-owners is straightforward. 
* Art & Animation: We brought old artists on for more hours and hired two new artists, we are also working with an additional 3D artist/animator who is poised to become our technical art director with over 30 years of experience in 3D. So far this year, our art team has doubled!
* Game Dev & Design: We have brought in professional resources when it comes to game design and development, significantly expanding the size and experience of our game development team.
* Notion & Automation: We have brought on efficiency experts and wholly overhauled our use of Notion to unlock the full potential of all team members. This includes an expert in automation for easier tracking of tasks, projects, finances, and roadmaps.

![](<https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/Aesor World Chest Ephyran Concept 2 winter.jpg>)

Ephyran Armor Concepts

![](https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/ephyran_male_blue.jpg)

Ephyran Armor Production Drafts
...
![](<https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/Avatars Armoury - Desktop.png>)

Application “Avatar Selection” Draft
...
![](<https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/Gear Armoury - Desktop.png>)

Application “Gear Selection” Draft
...
![](<https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/NT legendary sets.jpg>)

Neo Tokyo Cross-IP Production Pieces
...
![](https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/ntchest8.jpg)

Neo Tokyo Cross-IP Chest – Work in Progress
...
* Initial token launch
  ![](https://kingdom-tinacms-store.s3.us-east-1.amazonaws.com/ephyr_sketches_1.jpg)
